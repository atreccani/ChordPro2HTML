...
#define VERSION_STR_NAME				"ChordPro2HTML"
...
#define VERSION_STR_DESCRIPTION			"Command line converter from ChordPro (lyrics + chords) to HTML (hypertext markup language)."
...
#define VERSION_STR_COMPANYDOMAIN		"https://github.com/atreccani/ChordPro2HTML"
